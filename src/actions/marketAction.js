...
export const createItem = (formValue) => {
    return async dispatch => {
        ...
        await sqlApi.get(`/insertItem?creater=vincent&image=${formValue.picture}&description=${formValue.description}&price=${formValue.price}&create_time=2019-02-02%2000:00:00&title=${formValue.title}`); 
